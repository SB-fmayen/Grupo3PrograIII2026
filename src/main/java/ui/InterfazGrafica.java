 ...
 * Incluye: barra de fórmulas, numeración de filas, cortar/copiar/pegar.
 */
public class InterfazGrafica extends JFrame {
    ...
    private void actualizarBarraFormula(JTable tabla, HojaCalculo hoja) {
        ...
        // Mostrar el RAW (fórmula original) no el resultado
