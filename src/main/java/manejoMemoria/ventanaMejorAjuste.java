 ...
 *
 */
public class ventanaMejorAjuste extends javax.swing.JFrame {
    mejorAjuste Ventana = new mejorAjuste();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaMejorAjuste.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventanaMejorAjuste().setVisible(true);
            }
        });
    }
