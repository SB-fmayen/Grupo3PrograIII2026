...
public class Main {
    ...
    private static void mostrarMenuPrincipal() {
        ...
        JPanel botones = new JPanel(new GridLayout(4, 1, 10, 12));
        botones.setOpaque(false);
        botones.setBorder(BorderFactory.createEmptyBorder(15, 0, 0, 0));

        JButton btn1 = crearBoton("1.  Hoja de Calculo", new Color(0, 120, 215));
        ...
        btn3.addActionListener(e -> JOptionPane.showMessageDialog(menu,
            "Esta opcion esta en desarrollo.", "En Desarrollo",
